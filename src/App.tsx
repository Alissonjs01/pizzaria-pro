  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 p-6 max-w-7xl mx-auto">
        ...
        {/* Tabela */}
        <div className="bg-black/40 backdrop-blur-sm rounded-2xl border border-gray-700 overflow-hidden shadow-lg opacity-0 animate-fadeInUp" style={{ animationDelay: "1s" }}>
                ...
                <tr key={i} className="hover:bg-gray-800/50 transition-colors">
                  ...
                  <td className="p-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide ${
                      row.status === "Em preparo" ? "bg-red-900/60 text-red-200" :
                      row.status === "Saiu" ? "bg-yellow-900/60 text-yellow-200" :
